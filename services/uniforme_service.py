...
class UniformeService:
    ...
    def insert_uniforme(self, main_window):
        ...
        try:
            ...
            QMessageBox.warning(main_window, 'Uniformes', f'Erro ao cadastrar uniforme.\nErro : {e}')

    def update_uniforme(self, main_window):
        self.uniforme_to_update = None
        if main_window.pushButton.text() == 'Editar':
            ...
            main_window.pushButton.setText('Atualizar')
        else:
            ...
            try:
                ...
                main_window.pushButton.setText('Editar')
                main_window.txt_nome_uniforme.text('')
                self.service_main_window.populate_table_uniforme(main_window)
            except Exception as e:
                QMessageBox.warning(main_window, 'Uniformes', f'Erro ao atualizar uniforme.\nErro : {e}')
    ...
    def delete_uniforme(self, main_window):
        ...
        msg_box.setText(f'Tem certeza de que deseja remover o uniforme {self.uniforme_to_update.nome}?')
        ...
        if msg_box.clickedButton() == yes_button:
            try:
                ...
                QMessageBox.warning(main_window, "Atenção", f'Problema ao remover uniforme.\n'
                                                            f'Erro: {e}')
